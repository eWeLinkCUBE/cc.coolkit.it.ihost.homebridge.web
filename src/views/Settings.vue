    ...
    <div class="settings">
        ...
        <div class="card-wrapper">
            <div class="card" v-for="(item, index) in iHostList" :key="index">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary btn-sm">{{ t('SETTINGS.GET_TOKEN') }}</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body searchIHost pointer" @click="handleClickQueryIHostCard">
        ...
        <div class="link-iHost" v-if="showAddIHostModal">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" :placeholder="t('SETTINGS.ADD_IHOST_PLACEHOLDER')" />
                <span class="input-group-text pointer">Link</span>
            </div>
        </div>
        <!-- log -->
...
const { t } = useI18n()
const { iHostList } = storeToRefs(useIHostStore())
